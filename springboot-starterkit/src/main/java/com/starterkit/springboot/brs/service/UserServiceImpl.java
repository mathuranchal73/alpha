...
public class UserServiceImpl implements UserService {
    ...
    public UserDto signup(UserDto userDto) {
        ...
        if (user == null) {
            ...
            user = new User(userDto.getEmail(),bCryptPasswordEncoder.encode(userDto.getPassword()),userDto.getFirstName(),userDto.getLastName(),userDto.getMobileNumber(),new HashSet<>(Arrays.asList(userRole)));
