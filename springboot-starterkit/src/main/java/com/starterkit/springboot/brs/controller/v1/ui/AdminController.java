...
public class AdminController {
    ...
    private UserDto registerAdmin(@Valid AdminSignupFormCommand adminSignupRequest) {
        UserDto userDto = new UserDto();
        		...
        		userDto.setMobileNumber(adminSignupRequest.getMobileNumber());
        		userDto.setAdmin(true);
        UserDto admin = userService.signup(userDto); //register the admin
        AgencyDto agencyDto = new AgencyDto();
        		agencyDto.setName(adminSignupRequest.getAgencyName());
        		agencyDto.setDetails(adminSignupRequest.getAgencyDetails());
